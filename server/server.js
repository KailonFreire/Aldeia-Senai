...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'https://aldeia-senai.vercel.app');
...
app.listen(5000, () => console.log('Server is running on port https://aldeia-senai-server.vercel.app'));
